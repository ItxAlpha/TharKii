# K45HM1R11# S4Q11# THUGL1F3# D3M0N# S3RL4H#!/usr/bin/python2
...
\033[1;96mHATERX MAKES ME FAMOUS S4Q1 K1NG ..

\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••      

\33[1;94m☠OTHERS : THE MASTER MIND TRICKERS჻\033[1;96m☣L3G3ND: S4Q11 FEEL THE POWER჻\033[1;91m☣FACEBOOK: MOHSIN RAZA჻\033[1;92m☣WhatsApp:03063112***\033[1;94m☣FRIEND YT: TAIMUR Creations\033[1;97m☣CREATOR : MOHSIN ALI THE BRAND\033[1;97m============================================
...
\033[1;91m---------------------SAQII THE BRAND-------------------

\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••      

\033[1;96mHATER MAKES ME FAMOUS DEMON ON FIRE ..
...
CorrectUsername = "BHIMBER"

CorrectPassword = "SERLAH"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            print "Logged in successfully as " + username #Dev:54Q11
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://www.facebook.com/54Q11.ALL.HATERX.KA.PAPA.FEEL.THE.POWER')
...
def Zeek():
    ...
    print '\x1b[1;91m[1]  START CLONING With 54Q11'

    time.sleep(0.10)

    print '\x1b[1;92m[2] ItxRealDemon FB ACCOUNT'
    ...
    print '\x1b[1;91m[6] ItxRealDemon FACEBOOK'
